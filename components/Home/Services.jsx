            ...
            <div className="services__wrapper-items">
              {services.map((service) => (
                <section key={service.id} className="services__item">
                  <figure
                    className="services__item-wrapper-icon"
                    style={{ backgroundColor: service.wrapperIconColor }}
                  >
                    <img
                      src={`/assets/icons/services/${service.icon}`}
                  ...
                  <div>
                    ...
                    <p className="services__item-subtitle">
                      {service.numberProjects} Projects
                    </p>
                  </div>
                </section>
              ))}
